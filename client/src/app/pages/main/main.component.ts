...
export class MainComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  selectedChat: ChatRoomResponse = {};
  chats: Array<ChatRoomResponse> = [];
  ...
  chatSelected(chatResponse: ChatRoomResponse) {
  ...
  private handleNotification(notification: Notification) {
    ...
    if (this.selectedChat && this.selectedChat.id === notification.chatRoomId) {
      ...
      const destChat = this.chats.find(c => c.id === notification.chatRoomId);
